...
model = load_model(r'C:\Users\sahas\OneDrive\Documents\visual studio code\bird species identification\BC.h5',compile=False)
...
def run():
    img1 = Image.open(r"C:\Users\sahas\Downloads\bird.jpg")
    img1 = img1.resize((350,350))
    st.image(img1,use_column_width=False)
    st.title("Birds Species Classification")
    st.markdown('''<h4 style='text-align: left; color: #d73b5c;'>* Data is based "325 Bird Species"</h4>''',
